...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', "django-insecure-=*@$qdhl_iqf+ocq*c4*xmv^_35o)rzu3-^e)_qe@xubmqzzk7")
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'demperm_social'),
